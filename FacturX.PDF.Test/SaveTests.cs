...
namespace FacturX.PDF.Test
{
    ...
    public sealed class SaveTests : TestBase
    {
        ...
        public async Task BasicSaveExampleFile()
        {
            ...
            await InvoicePdfProcessor.SaveToPdfAsync(targetPath, FacturXVersion.Version23, Profile.Comfort, FacturXFormats.CII, sourcePath, descriptor);
        ...
        public async Task BasicSaveExampleAsStream()
        {
            ...
            {                
                await InvoicePdfProcessor.SaveToPdfAsync(targetStream, FacturXVersion.Version23, Profile.Comfort, FacturXFormats.CII, sourceStream, descriptor);
            }
        ...
        public async Task BasicSaveFromNonExistingPdfFile()
        {
            ...
            InvoiceDescriptor descriptor = new InvoiceProvider().CreateInvoice();
            await Assert.ThrowsExceptionAsync<FileNotFoundException>(() => InvoicePdfProcessor.SaveToPdfAsync(targetPath, FacturXVersion.Version23, Profile.Comfort, FacturXFormats.CII, sourcePath, descriptor));
        ...
        public async Task TestFileWithPassword()
        {
            ...
            InvoiceDescriptor descriptor = new InvoiceProvider().CreateInvoice();
            await InvoicePdfProcessor.SaveToPdfAsync(targetPath, FacturXVersion.Version23, Profile.Comfort, FacturXFormats.CII, sourcePath, descriptor, password: "SecretPassw.rd");
        ...
        public async Task TestSaveFilenameVersion1()
        {
            ...
            using (FileStream sourceStream = new FileStream(sourcePath, FileMode.Open, FileAccess.Read))
            {
                await InvoicePdfProcessor.SaveToPdfAsync(targetStream, FacturXVersion.Version1, Profile.Comfort, FacturXFormats.CII, sourceStream, descriptor);
            }            
        ...
        public async Task TestSaveFilenameVersion20()
        {
            ...
            using (FileStream sourceStream = new FileStream(sourcePath, FileMode.Open, FileAccess.Read))
            {
                await InvoicePdfProcessor.SaveToPdfAsync(targetStream, FacturXVersion.Version20, Profile.Comfort, FacturXFormats.CII, sourceStream, descriptor);
            }            
        ...
        public async Task TestSaveFilenameVersion23XRechnung()
        {
            ...
            using (FileStream sourceStream = new FileStream(sourcePath, FileMode.Open, FileAccess.Read))
            {
                await InvoicePdfProcessor.SaveToPdfAsync(targetStream, FacturXVersion.Version23, Profile.XRechnung, FacturXFormats.CII, sourceStream, descriptor);
            }            
        ...
        public async Task TestWithoutBasefont()
        {
            ...
            using (FileStream sourceStream = new FileStream(sourcePath, FileMode.Open, FileAccess.Read))
            {
                await InvoicePdfProcessor.SaveToPdfAsync(targetStream, FacturXVersion.Version23, Profile.Extended, FacturXFormats.CII, sourceStream, descriptor);
            }
