...
namespace FacturX.PDF
{
    internal class InvoiceDescriptorPdfSaver
    {
        internal static async Task SaveAsync(Stream targetStream, FacturXVersion version, Profile profile, FacturXFormats format, Stream pdfSourceStream, InvoiceDescriptor descriptor, string password = null)
        {
        ...
        internal static async Task SaveAsync(string targetPath, FacturXVersion version, Profile profile, FacturXFormats format, string pdfSourcePath, InvoiceDescriptor descriptor, string password = null)
        {
        ...
        private static byte[] _CreateFacturXBytes(Stream pdfStream, MemoryStream xmlStream, FacturXVersion version, Profile profile, string invoiceFilename, string documentTitle = null, string documentDescription = null, string password = null)
        {
            if (pdfStream == null)
            {
            ...
            switch (version)
            {
                case FacturXVersion.Version1:
                    xmpVersion = "1.0";
                    break;
                case FacturXVersion.Version20:
                    xmpVersion = "2p0";
                    break;
                case FacturXVersion.Version23:
            ...
            switch (version)
            {
                case FacturXVersion.Version1: metadataResource = "FacturX.PDF.Resources.PdfMetadataTemplate-1.0.xml"; break;
                case FacturXVersion.Version20: metadataResource = "FacturX.PDF.Resources.PdfMetadataTemplate-2.0.xml"; break;
                case FacturXVersion.Version23: metadataResource = "FacturX.PDF.Resources.PdfMetadataTemplate-2.3.xml"; break;
            }
        ...
        //    metadataDictionary.Elements.Add("/Filter", new PdfName("/FlateDecode"));
            ...
            rgbProfileDict.CreateStream(_LoadEmbeddedResource("FacturX.PDF.Resources.sRGB-IEC61966-2.1.icc"));
        ...
        private static string _DetermineFilenameBasedOnVersionAndProfile(FacturXVersion version, Profile profile)
        {
            if (version == FacturXVersion.Version1)
            {
                return "ZUGFeRD-invoice.xml";
            }
            else if (version == FacturXVersion.Version20)
            {
                return "zugferd-invoice.xml";
            }
            else
