...
namespace FacturX.Test
{
    ...
    public class ZUGFeRD20Tests : TestBase
    {
        ...
        public void TestLineStatusCode()
        {
            ...
            desc.Save(ms, FacturXVersion.Version20, Profile.Extended);
        ...
        public void TestTotalRounding()
        {
            ...
            desc.Save(msExtended, FacturXVersion.Version20, Profile.Extended);
            ...
            desc.Save(msBasic, FacturXVersion.Version20);
        ...
        public void TestStoringSepaPreNotification()
        {
            ...
            {
                d.Save(stream, FacturXVersion.Version20, Profile.Comfort);
