...
namespace FacturX.Test
{
    ...
    public class ZUGFeRD10Tests : TestBase
    {
        ...
        public void TestReferenceComfortInvoiceRabattiert()
        {
            ...
            desc.Save("test.xml", FacturXVersion.Version1, Profile.Comfort);
        ...
        public void TestStoringInvoiceViaFile()
        {
            ...
            desc.Save(path, FacturXVersion.Version1, Profile.Comfort);
        ...
        public void TestStoringInvoiceViaStreams()
        {
            ...
            desc.Save(saveStream, FacturXVersion.Version1, Profile.Comfort);
            saveStream.Close();
            ...
            desc.Save(ms, FacturXVersion.Version1, Profile.Comfort);
