...
namespace FacturX.Test
{
    ...
    public class XRechnungUBLTests : TestBase
    {
        ...
        private FacturXVersion _Version = FacturXVersion.Version23;
        ...
        public void TestTradelineitemProductCharacterstics()
        {
            ...
            desc.Save(ms, _Version, Profile.XRechnung, FacturXFormats.UBL);
            ms.Seek(0, SeekOrigin.Begin);
        ...
        public void TestPartyIdentificationForSeller()
        {
            ...
            loadedInvoice.Save(resultStream, FacturXVersion.Version23, Profile.XRechnung, FacturXFormats.UBL);
        ...
        public void TestApplicableTradeTaxWithExemption()
        {
            ...
            MemoryStream ms = new MemoryStream();
            descriptor.Save(ms, FacturXVersion.Version23, Profile.XRechnung, FacturXFormats.UBL);
        ...
        public void TestDesignatedProductClassificationWithFullClassification()
        {
            ...
            desc.Save(tempPath, FacturXVersion.Version23, Profile.XRechnung, FacturXFormats.UBL);
