...
namespace FacturX.Test
{
    ...
    public class ZUGFeRD22Tests : TestBase
    {
        ...
        {
            string path = @"..\..\..\..\demodata\FacturX21\zugferd_2p1_EXTENDED_Warenrechnung-factur-x.xml";
        ...
        {
            string path = @"..\..\..\..\demodata\FacturX21\zugferd_2p1_EREPORTING-factur-x.xml";
            path = _makeSurePathIsCrossPlatformCompatible(path);
        ...
        {
            string path = @"..\..\..\..\demodata\FacturX21\zugferd_2p1_BASIC_Einfach-factur-x.xml";
            path = _makeSurePathIsCrossPlatformCompatible(path);
        ...
        public void TestStoringReferenceBasicFacturXInvoice()
        {
            ...
            originalDesc.Save(ms, FacturXVersion.Version23, Profile.Basic);
            originalDesc.Save(@"zugferd_2p1_BASIC_Einfach-factur-x_Result.xml", FacturXVersion.Version23);
        ...
        {
            string path = @"..\..\..\..\demodata\FacturX21\zugferd_2p1_BASIC-WL_Einfach-factur-x.xml";
            path = _makeSurePathIsCrossPlatformCompatible(path);
        ...
        {
            string path = @"..\..\..\..\documentation\FacturX240en\Examples\4. EXTENDED\EXTENDED_Warenrechnung\EXTENDED_Warenrechnung.xml";
            path = _makeSurePathIsCrossPlatformCompatible(path);
        ...
        {
            string path = @"..\..\..\..\demodata\FacturX21\zugferd_2p1_MINIMUM_Rechnung-factur-x.xml";
            path = _makeSurePathIsCrossPlatformCompatible(path);
        ...
        public void TestMinimumInvoice()
        {
            ...
            desc.Save(ms, FacturXVersion.Version23, Profile.Minimum);
            ms.Seek(0, SeekOrigin.Begin);
        ...
        public void TestInvoiceWithAttachmentComfort()
        {
            ...
            desc.Save(ms, FacturXVersion.Version23, Profile.Comfort);
            ms.Seek(0, SeekOrigin.Begin);
        ...
        public void TestInvoiceWithAttachmentBasic()
        {
            ...
            desc.Save(ms, FacturXVersion.Version23, Profile.Basic);
            ms.Seek(0, SeekOrigin.Begin);
        ...
        public void TestXRechnung1()
        {
            ...
            desc.Save(ms, FacturXVersion.Version23, Profile.XRechnung1);
            ms.Seek(0, SeekOrigin.Begin);
            Assert.AreEqual(desc.Profile, Profile.XRechnung1);
        ...
        public void TestCreateInvoice_WithProfileEReporting()
        {
            ...
            desc.Save(ms, FacturXVersion.Version23, Profile.EReporting);
            Assert.AreEqual(desc.Profile, Profile.EReporting);
        ...
        public void TestTotalRoundingExtended()
        {
            ...
            desc.Save(msExtended, FacturXVersion.Version23, Profile.Extended);
            ...
            desc.Save(msBasic, FacturXVersion.Version23);
        ...
        public void TestTotalRoundingXRechnung()
        {
            ...
            var msExtended = new MemoryStream();
            desc.Save(msExtended, FacturXVersion.Version23, Profile.XRechnung);
            msExtended.Seek(0, SeekOrigin.Begin);
        ...
        {
            var path = @"..\..\..\..\demodata\FacturX21\zugferd_2p1_BASIC_Einfach-factur-x.xml";
            path = _makeSurePathIsCrossPlatformCompatible(path);
        ...
        public void TestWriteTradeLineProductCharacteristics()
        {
            ...
            {
                originalInvoiceDescriptor.Save(memoryStream, FacturXVersion.Version23, Profile.Basic);
                originalInvoiceDescriptor.Save(@"xrechnung with trade line settlement filled.xml", FacturXVersion.Version23);
        ...
        public void TestWriteTradeLineChargeFreePackage()
        {
            ...
            using (var memoryStream = new MemoryStream())
            {
                originalInvoiceDescriptor.Save(memoryStream, FacturXVersion.Version23, Profile.Extended);
                originalInvoiceDescriptor.Save(@"xrechnung with trade line settlement filled.xml", FacturXVersion.Version23, Profile.Extended);
        ...
        {
            string path = @"..\..\..\..\demodata\FacturX21\zugferd_2p1_EN16931_SEPA_Prenotification.xml";
            path = _makeSurePathIsCrossPlatformCompatible(path);
        ...
        public void TestStoringSepaPreNotification()
        {
            ...
            {
                d.Save(stream, FacturXVersion.Version23, Profile.Comfort);
        ...
        public void TestValidTaxTypes()
        {
            ...
            try
            {
                invoice.Save(ms, version: FacturXVersion.Version23, profile: Profile.Basic);
            }
            ...
            try
            {
                invoice.Save(ms, version: FacturXVersion.Version23, profile: Profile.BasicWL);
            }
            catch (UnsupportedException)
            {
                Assert.Fail();
            ...
            try
            {
                invoice.Save(ms, version: FacturXVersion.Version23, profile: Profile.Comfort);
            }
            catch (UnsupportedException)
            {
                Assert.Fail();
            ...
            try
            {
                invoice.Save(ms, version: FacturXVersion.Version23, profile: Profile.Extended);
            }
            catch (UnsupportedException)
            {
                Assert.Fail();
            ...
            try
            {
                invoice.Save(ms, version: FacturXVersion.Version23, profile: Profile.XRechnung1);
            }
            catch (UnsupportedException)
            {
                Assert.Fail();
            ...
            try
            {
                invoice.Save(ms, version: FacturXVersion.Version23, profile: Profile.XRechnung);
            }
            catch (UnsupportedException)
            {
                Assert.Fail();
        ...
        public void TestShipTo()
        {
            ...
            // test basic wl
            ms = new MemoryStream();
            desc.Save(ms, FacturXVersion.Version23, Profile.BasicWL);
            ms.Seek(0, SeekOrigin.Begin);
            loadedInvoice = InvoiceDescriptor.Load(ms);
        ...
        public void TestWriteAndReadExtended()
        {
            ...
            ms.Seek(0, SeekOrigin.Begin);
            Assert.AreEqual(InvoiceDescriptor.GetVersion(ms), FacturXVersion.Version23);
        ...
        public void TestTradeAllowanceChargeWithoutExplicitPercentage()
        {
            ...
            MemoryStream ms = new MemoryStream();
            invoice.Save(ms, FacturXVersion.Version23, Profile.Extended);
            ms.Position = 0;
        ...
        public void TestWriteAndReadDespatchAdviceDocumentReferenceAllProfilesButMinimum(Profile profile)
        {
            ...
            MemoryStream ms = new MemoryStream();
            desc.Save(ms, FacturXVersion.Version23, profile);
            ms.Seek(0, SeekOrigin.Begin);
            InvoiceDescriptor loadedInvoice = InvoiceDescriptor.Load(ms);
        ...
        public void TestSpecifiedTradeAllowanceCharge(Profile profile)
        {
            ...
            MemoryStream ms = new MemoryStream();
            invoice.Save(ms, FacturXVersion.Version23, profile);
            ms.Position = 0;
        ...
        public void TestTradeLineItemsNotWrittenInMinimum()
        {
            ...
            MemoryStream ms = new MemoryStream();
            invoice.Save(ms, FacturXVersion.Version23, Profile.Minimum);
            ms.Position = 0;
        ...
        **/
        ...
        public void TestSingleXRechnungStructuredManually()
        {
            ...
            MemoryStream ms = new MemoryStream();
            desc.Save(ms, FacturXVersion.Version23, Profile.XRechnung, FacturXFormats.CII);
            // desc.Save("e:\\output.xml", FacturXVersion.Version23, Profile.XRechnung);
        ...
        {
            string path = @"..\..\..\..\demodata\FacturX22\zugferd_2p2_EXTENDED_Fremdwaehrung-factur-x.xml";
            path = _makeSurePathIsCrossPlatformCompatible(path);
        ...
        public void TestRequiredDirectDebitFieldsShouldExist()
        {
            ...
            using (var stream = new MemoryStream())
            {
                d.Save(stream, FacturXVersion.Version23, Profile.XRechnung);
                stream.Seek(0, SeekOrigin.Begin);
        ...
        {
            string path = @"..\..\..\..\documentation\FacturX23en\Examples\2. BASIC\BASIC_Einfach\factur-x.xml";
            path = _makeSurePathIsCrossPlatformCompatible(path);
        ...
        {
            string path = @"..\..\..\..\documentation\FacturX23en\Examples\4. EXTENDED\EXTENDED_Warenrechnung\factur-x.xml";
            path = _makeSurePathIsCrossPlatformCompatible(path);
        ...
        {
            string path = @"..\..\..\..\documentation\FacturX23de\Beispiele\4. EXTENDED\EXTENDED_InnergemeinschLieferungMehrereBestellungen\factur-x.xml";
            path = _makeSurePathIsCrossPlatformCompatible(path);
        ...
        public void TestLoadingInvoiceType()
        {
            ...
            // load correction
            path = @"..\..\..\..\documentation\FacturX23en\Examples\4. EXTENDED\EXTENDED_Rechnungskorrektur\factur-x.xml";
            path = _makeSurePathIsCrossPlatformCompatible(path);
        ...
        public void TestAccountingCost()
        {
            ...
            using (var stream = new MemoryStream())
            {
                d.Save(stream, FacturXVersion.Version23, Profile.XRechnung, FacturXFormats.UBL);
        ...
        {
            string path = @"..\..\..\..\demodata\FacturX22\zugferd_23_namespace.xml";
            path = _makeSurePathIsCrossPlatformCompatible(path);
        ...
        {
            string path = @"..\..\..\..\demodata\FacturX22\zugferd_23_local_namespaces.xml";
            path = _makeSurePathIsCrossPlatformCompatible(path);
