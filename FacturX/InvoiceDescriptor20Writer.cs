...
namespace FacturX
{
    internal class InvoiceDescriptor20Writer : IInvoiceDescriptorWriter
    {
        ...
        public override void Save(InvoiceDescriptor descriptor, Stream stream, FacturXFormats format = FacturXFormats.CII, InvoiceFormatOptions options = null)
        {
            ...
            _Writer.WriteElementString("ram", "ID", this._Descriptor.Profile.EnumToString(FacturXVersion.Version20));
