...
namespace FacturX
{
    ...
    public class InvoiceDescriptor
    {
        ...
        public static FacturXVersion GetVersion(string filename)
        {
            ...
            if (reader.IsReadableByThisReaderVersion(filename))
            {
                return FacturXVersion.Version20;
            }
        ...
        /// <returns>ZUGFeRD version of the invoice that was passed to the function</returns>
        public static FacturXVersion GetVersion(Stream stream)
        {
            IInvoiceDescriptorReader reader = new InvoiceDescriptor1Reader();
        ...
        private static IInvoiceDescriptorWriter _SelectInvoiceDescriptorWriter(FacturXVersion version)
        {
            switch (version)
            {
        ...
        public void Save(Stream stream, FacturXVersion version = FacturXVersion.Version23, Profile profile = Profile.Basic, FacturXFormats format = FacturXFormats.CII, InvoiceFormatOptions options = null)
        {
        ...
        /// <param name="format">Output format (CII or UBL)</param>
        /// <param name="options">Optional `InvoiceFormatOptions`</param>
        public void Save(string filename, FacturXVersion version = FacturXVersion.Version23, Profile profile = Profile.Basic, FacturXFormats format = FacturXFormats.CII, InvoiceFormatOptions options = null)
        {
            this.Profile = profile;
            IInvoiceDescriptorWriter writer = _SelectInvoiceDescriptorWriter(version);
