    ...
    public static class ProfileExtensions
    {
        internal static Profile FromString(this Profile _, string s)
        {
            var profileMap = new Dictionary<string, Profile>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                // v2
                { "urn:FacturX.de:2p0:minimum", Profile.Minimum },
                { "urn:zugferd.de:2p0:minimum", Profile.Minimum },
                { "urn:cen.eu:en16931:2017#compliant#urn:FacturX.de:2p0:basic", Profile.Basic },
                { "urn:cen.eu:en16931:2017#compliant#urn:zugferd.de:2p0:basic", Profile.Basic },
                { "urn:FacturX.de:2p0:basicwl", Profile.BasicWL },
                { "urn:zugferd.de:2p0:basicwl", Profile.BasicWL },
                { "urn:cen.eu:en16931:2017", Profile.Comfort },
                { "urn:cen.eu:en16931:2017#compliant#urn:FacturX.de:2p0:comfort", Profile.Comfort },
                { "urn:cen.eu:en16931:2017#compliant#urn:zugferd.de:2p0:comfort", Profile.Comfort },
                { "urn:cen.eu:en16931:2017#conformant#urn:FacturX.de:2p0:extended", Profile.Extended },
        ...
        internal static string EnumToString(this Profile profile, FacturXVersion version)
        {
            switch (version)
            {
                ...
                case FacturXVersion.Version20:
                    switch (profile)
                    {
                        case Profile.Minimum: return "urn:FacturX.de:2p0:minimum";
                        case Profile.Basic: return "urn:cen.eu:en16931:2017#compliant#urn:FacturX.de:2p0:basic";
                        case Profile.BasicWL: return "urn:FacturX.de:2p0:basicwl";
                        case Profile.Comfort: return "urn:cen.eu:en16931:2017";
                        case Profile.Extended: return "urn:cen.eu:en16931:2017#conformant#urn:FacturX.de:2p0:extended";
                ...
                default:
                    // return "";
                    throw new UnsupportedException("New FacturXVersion '" + version + "' defined but not implemented!");
            }
        } // !EnumToString()
