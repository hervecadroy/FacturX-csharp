...
namespace FacturX
{
    internal abstract class IInvoiceDescriptorWriter
    {
        ...
        public abstract void Save(InvoiceDescriptor descriptor, Stream stream, FacturXFormats format = FacturXFormats.CII, InvoiceFormatOptions options = null);


        public void Save(InvoiceDescriptor descriptor, string filename, FacturXFormats format = FacturXFormats.CII, InvoiceFormatOptions options = null)
        {
