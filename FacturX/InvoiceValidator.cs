...
namespace FacturX
{
    ...
    {
        public static void ValidateAndPrint(InvoiceDescriptor descriptor, FacturXVersion version, string filename = null)
        {
        ...
        public static ValidationResult Validate(InvoiceDescriptor descriptor, FacturXVersion version)
        {
